...
"""
g1 = momentsml.learn.MLParams(name = "g1",
...
net = momentsml.learn.tenbilacwrapper.TenbilacParams("tbl-1.cfg")

s1 = momentsml.learn.MLParams(name = "s1",
	inputs = ["adamom_g1", "adamom_sigma"],
	targets = ["tru_s1"],
	predictions = ["pre_s1"])

s2 = momentsml.learn.MLParams(name = "s2",
...
"""
g1test1 = momentsml.learn.MLParams(name = "g1",
	inputs = ["adamom_g1", "adamom_g1*adamom_sigma", "adamom_g1/adamom_sigma", "adamom_g2","adamom_sigma"],
	targets = ["tru_g1"],
	predictions = ["pre_g1"])

test1 = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "test1", hidden_nodes = [5,5],
...
#msb = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb", hidden_nodes = [3, 3],
#	errfctname="msb", valfrac=0.1, shuffle=True,
...
msbtw = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb", hidden_nodes = [-2],
	n = 1, algo="brute",
	errfctname="msb", valfrac=0.1, shuffle=True,
...
msb1 = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb", hidden_nodes = [1],
...
msb5 = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb5", hidden_nodes = [5],
	errfctname="msb", valfrac=0.5, shuffle=True,
	ininoisewscale = 0.05, ininoisebscale = 0.05,
...
msb5n = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb5n", hidden_nodes = [5],
	errfctname="msb", valfrac=0.5, shuffle=True,
...
msb55n = momentsml.learn.tenbilacwrapper.TenbilacParams(name = "msb55n", hidden_nodes = [5, 5],
	errfctname="msb", valfrac=0.5, shuffle=True,
	ininoisewscale = 0.2, ininoisebscale = 0.2,
	mbsize=None, mbfrac=0.1, mbloops=5, max_iterations=30, gtol=1e-20, startidentity=True,
	normtargets=False, normtype="-11", actfctname="tanh", oactfctname="iden",
