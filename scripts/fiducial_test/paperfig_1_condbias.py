...
useVO = False # Use VO set vor validating 
useweights = True # <--- to be used with a "VP" like structure in place of "VO".
...
if useweights is False:
        if useVO is False:
                ...
                valname = config.valname2 #to validate point like using overall sims
                select = False
else:
...
#comment here
print("hola", cat["tru_rad"].shape ,cat["tru_psf_sigma"].shape)
