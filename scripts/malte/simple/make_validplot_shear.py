...
momentsml.plot.bin.res(ax, cat, Feature("tru_s2"), Feature("pre_s2", rea="full"), ebarmode=ebarmode)
ax = fig.add_subplot(3, 4, 10)
momentsml.plot.bin.res(ax, cat, Feature("tru_s2"), Feature("pre_s2", rea="full"), Feature("tru_flux", rea="full"), ncbins=3, equalcount=True, ebarmode=ebarmode)
ax = fig.add_subplot(3, 4, 11)
momentsml.plot.bin.res(ax, cat, Feature("tru_s2"), Feature("pre_s2", rea="full"), Feature("tru_rad", rea="full"), ncbins=3, equalcount=True, ebarmode=ebarmode)
ax = fig.add_subplot(3, 4, 12)
momentsml.plot.bin.res(ax, cat, Feature("tru_s2"), Feature("pre_s2", rea="full"), Feature("tru_g", rea="full"), ncbins=3, equalcount=True, ebarmode=ebarmode)
