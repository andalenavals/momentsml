...
def quicktest(cat,
	...
	e1m = momentsml.tools.metrics.metrics(cat, labelfeature=Feature(colname_tru_s1), predlabelfeature=Feature(colname_pre_s1))
	e2m = momentsml.tools.metrics.metrics(cat, labelfeature=Feature(colname_tru_s2), predlabelfeature=Feature(colname_pre_s2))
